/* See LICENSE fele fr copyright and license details. */
...
static const char *colors[][3] = {
    ...
    [SchemeSel] = {col_3, col_cyan, col_cyan},
...
static const char *rngr[] = {"alacritty", "-e", "ranger", NULL};
...
static const char *cmdprintscreen[] = {
    "scrot", "--select", "--quality", "100", "-e", "mv $f ~/pics/screenshots/",
    NULL};
